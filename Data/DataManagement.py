...
print(DataManagement.get_data_case_contry('Peru'))
print(DataManagement.get_data_case_contry_by_year('Brazil', 2020))
print(DataManagement.global_case_values())
print(DataManagement.max_min_case_by_country('Colombia'))
print(DataManagement.max_min_case_by_country_by_year('Peru', 2020))